<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">{{ __('auth.login') }}</h2>
        <p class="mt-2 text-lg/8 text-gray-600">{{ __('auth.login_description') }}</p>
    </div>

    {{-- Login Form --}}
    <form wire:submit="authenticate" class="mx-auto mt-16 max-w-xl sm:mt-20">
